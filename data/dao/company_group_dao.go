...
func (dao *CompanyGroupDAO) Create(cg *entities.CompanyGroup) (id int64, err error) {
	row := dao.Connection.QueryRowContext(dao.Ctx,
		...
		cg.Name, cg.Activate, cg.CountryId, cg.CountrySubdivisionId,
	)
